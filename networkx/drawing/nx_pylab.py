...
#nx.compat.matplotlib_compat._setup_aliases()
...
def draw(G, pos=None, ax=None, hold=None, **kwds):
    ...
    try:
        ...
        plt.clf()  # Clear the plot before raising the exception
        raise
    plt.clf()  # Clear the plot before returnin
    return
    """
        plt.hold(b)
        raise
